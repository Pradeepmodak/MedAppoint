    ...
    <div>
        ...
        <p className='font-medium'>Address:</p>
     {
      ...
      <div className='mt-10'>
        {
          isEdit
          ?<button onClick={updateUserProfileData} className='border border-[#5f6FFF] py-2 px-8 rounded-full hover:bg-[#5f6FFF] hover:text-white transition-all'>Save Changes</button>
