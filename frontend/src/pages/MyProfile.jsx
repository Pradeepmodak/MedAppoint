...
const MyProfile = () => {
  const [userData,setUserData]=useState({
    ...
    phone:'+91 1256789010',
    address:{
      line1:"Km mallick Road, Lalpur , Ranchi , 834001",
      line2:"Near Dav Nandraj Modern School",
    },
    gender:'Male',
    dob:'2006-05-06',
  })
    ...
    <div>
        ...
        <p className='font-medium'>Address:</p>
     {
      ...
      <div className='mt-10'>
        {
          isEdit
          ?<button onClick={()=>setIsEdit(false)} className='border border-[#5f6FFF] py-2 px-8 rounded-full hover:bg-[#5f6FFF] hover:text-white transition-all'>Save Changes</button>
          :<button onClick={()=>setIsEdit(true)} className='border border-[#5f6FFF] py-2 px-8 rounded-full hover:bg-[#5f6FFF] hover:text-white transition-all'>Edit Profile</button>
        }
      </div>
    </div>
  )
