...
const DoctorAppointment = () => {
    const {dToken,appointments,getUserAppointments}=useContext(DoctorContext);
        ...
        <div className="bg-white border border-gray-200 rounded text-sm max-h-[80vh] min-h-[60vh] overflow-y-scroll">
            ...
            </div>
            {
                appointments.map((item,index)=>(
                    <div className='flex flex-wrap justify-between max-sm:gap-5 max-sm:text-base sm:grid grid-cols-[0.5fr_2fr_1fr_1fr_3fr_1fr_1fr] gap-1 items-center py-3 px-6 border-b border-gray-200 hover:bg-gray-50' key={index}>
                        ...
                        <div>
                            <p className='text-xs inline border border-gray-200  px-2 rounded-full'>
